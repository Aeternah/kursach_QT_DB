...
INSERT INTO jobs VALUES 
    ...
    (20, 'Programmer', 10000.00, 19000.00);
...
INSERT INTO employees VALUES 
    (100, 'Steven', 'King', 'sking.kochhar@sqltutorial.org', '515.123.4768', '1989-09-21', 4, 40000.00, NULL, 1),
    ...
    (105, 'David', 'Austin', 'david_austin@sqltutorial.org', '590.423.4569', '1997-06-25', 9, 4800.00, 103, 6),
    ...
    (109, 'Daniel', 'Faviet', 'daniel.faviet@sqltutorial.org', '515.124.4169', '1994-08-16', 9, 9000.00, 108, 10),
    ...
    (178, 'Kimberely', 'Grant', 'kimberely_grant@sqltutorial.org', NULL, '1999-05-24', 16, 7000.00, 100, 8),
    ...
    (204, 'Hermann', 'Baer', 'hermann_baer@sqltutorial.org', '515.123.8888', '1994-06-07', 12, 10000.00, 101, 7),
    (205, 'Shelley', 'Higgins', 'shelley.higgins@sqltutorial.org', '515.123.8080', '1994-06-07', 2, 12000.00, 101, 11),
    (206, 'William', 'Gietz', 'william.gietz@sqltutorial.org', '515.123.8181', '1994-06-07', 2, 8300.00, 205, 11),
    (207, 'Stevena', 'King', 'steven.king@sqltutorial.org', '515.123.4567', '1987-06-17', 4, 24000.00, NULL, 9),
    (221, 'Neen', 'King', 'neen.king@sqltutorial.org', '515.143.4567', '1987-06-17', 6, 7500.00, 114, 3),
    (220, 'Stevena', 'Hunold', 'sv.hunold@sqltutorial.org', '515.123.4569', '1987-06-17', 6, 6000.00, 114, 3),
    (300, 'Lexum', 'Chenna', 'l.c.@sqltutorial.org', '515.124.4569', '1999-12-07', 17, 1000.00, 123, NULL),
    (301, 'Ruslan', 'Roment', 'rus.rom@sqltutorial.org', NULL, '1999-02-07', 20, 15000.00, 300, 13),
    (302, 'Fis', 'Gert', 'fis.gert@sqltutorial.org', '515.123.5667', '1999-02-07', 20, 19000.00, 100, 13),
    (303, 'Mark', 'Johnson', 'mark.jns@sqltutorial.org', NULL, '1987-06-19', 14, 9000.00, 100, 9);
...
-- Вставка данных в иждивенцев
INSERT INTO dependents VALUES 
    (1, 'Penelope', 'Popp', 'Child', 113),
    ...
    (31, 'Karl', 'Mavris', 'Child', 203),
    (32, 'Vivien', 'Mavris', 'Child', 203);